...
[English](../en/README.md) | 中文 | [贡献流程](../../CONTRIBUTING.md) | [**下载最新镜像**](https://github.com/Cloud370/landscape-mini/releases/latest)
...
| `LOCALE` | `C.UTF-8` | 默认系统 locale |
| `EXTRA_LOCALES` | `en_US.UTF-8` | 额外生成的 Debian UTF-8 locale |
